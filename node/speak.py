...
# it's ok i read the license we can yoink it and twist as much or little as we want

# """Sample that implements a gRPC client for the Google Assistant API."""
# sample that hopefully does something with auido input
...
# Setup button
# WARNING :IDK IF THIS WORKS AS-IS ON THE PI
